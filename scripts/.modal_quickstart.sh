...
echo ""
echo "Next steps:"
echo "  1. Run training: modal run training/modal_train.py"
echo "  2. Download model: modal volume get chess-models chess_model_best.pth ./models/chess_model.pth"
echo ""
echo "For more options, see docs/MODAL_TRAINING.md"
